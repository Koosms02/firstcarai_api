...
function calcInsurance(price, locationFactor, riskFactor) {
...
async function main() {
    ...
    try {
        ...
        for (const carData of CARS) {
            ...
            const estimates = PROVINCES.flatMap((province) => RISK_FACTORS.map((risk) => ({
                carId: car.id,
            ...
            console.log(`  ${carData.make.padEnd(14)} ${carData.model.padEnd(42)} R${carData.price.toLocaleString().padStart(10)}  |  Gauteng: R${loGauteng}–R${hiGauteng}/mo`);
        }
