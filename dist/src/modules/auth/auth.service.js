...
let AuthService = class AuthService {
    ...
    async resetPassword(dto) {
        ...
        if (!user?.passwordResetToken || !user?.passwordResetExpiry) {
            throw new common_1.BadRequestException('No password reset was requested for this email.');
        }
        if (new Date() > user.passwordResetExpiry) {
            throw new common_1.BadRequestException('The reset code has expired. Please request a new one.');
        }
