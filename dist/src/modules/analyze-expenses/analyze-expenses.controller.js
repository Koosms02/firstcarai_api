...
exports.AnalyzeExpensesController = void 0;
const common_1 = require("@nestjs/common");
const analyze_expenses_service_1 = require("./analyze-expenses.service");
const analyze_expenses_dto_1 = require("./dto/analyze-expenses.dto");
let AnalyzeExpensesController = class AnalyzeExpensesController {
    service;
    constructor(service) {
